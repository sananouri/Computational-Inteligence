...
for k = 1:10
    ...
    %backpropagation
    W2 = W2 + eta * e_learn * O1';
    Wb2 = Wb2 + eta * e_learn * ones(70,1);
    WB2(1,:) = Wb2(1,1);
    delta = (W2' * e_learn).*diff_O1;
    W1 = W1 + eta * delta * learn_data';
    Wb1 = Wb1 + eta * (W2' * e_learn) * ones(70,1);
    for i = 1:10
        WB1(i,:) = Wb1(i,1);
    end
end
